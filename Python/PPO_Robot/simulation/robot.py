...
class BirdBipedEnv(gym.Env):
    ...
    def step(self, action):
        ...
        reward_forward = 2* forward_vel * max(0.0, heading_x)
        reward_alive = 1
        ...
        reward = reward_forward + reward_alive - cost_lateral - cost_action_rate - cost_ctrl - cost_pitch
